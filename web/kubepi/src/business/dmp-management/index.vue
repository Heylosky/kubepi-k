<template>
  <layout-content :header="$t('business.dmp.list')">
    ...
    <complex-table v-loading="loading" :search-config="searchConfig" :selects.sync="selects" :data="data"
      ...
      <el-table-column :label="$t('business.dmp.label')" align="left" min-width="160" fix>
        <template v-slot:default="{row}">
          <div style="font-size: 20px">
            ...
            <div style="padding-top: 5px;">
              <el-popover
                placement="top"
                width="160"
                :title="$t('commons.button.add')+$t('business.dmp.label')"
                trigger="manual"
      ...
      <el-table-column :label="$t('business.dmp.version')" min-width="100" fix>
        <template v-slot:default="{row}">
          <el-tag>
            {{ row.status.version }}
          </el-tag>
    ...
    return {
      ...
      searchConfig: {
        ...
        components: [
          ...
          {
            field: "labels",
            label: this.$t("business.dmp.label"),
